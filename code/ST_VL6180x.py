...
class VL6180X:
    ...
    def __init__(self, address=0x29, debug=False):
        ...
        elf.set_register(0x0097, 0x54) #range3 int value = 84
        ...
        #up the scaling to 3
        ptp_offset = self.get_register(SYSRANGE__PART_TO_PART_RANGE_OFFSET);
        self.set_register(self.__VL6180X_PART_TO_PART_RANGE_OFFSET, ptp_offset / 3)
