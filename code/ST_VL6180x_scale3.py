...
class VL6180X_3:
    ...
    #__VL6180X_PART_TO_PART_RANGE_OFFSET             = 0x024 #from polu arduino code
    ...
    def __init__(self, address=0x29, debug=False):
        ...
        #self.set_register(0x0097, 0xfd) #range scaler default
        self.set_register(0x0097, 0x54) #range3 int value = 84
    ...
    def default_settings(self):
        ...
        self.set_register(self.__VL6180X_FIRMWARE_RESULT_SCALER, 0xFE) #scaling3
         #up the scaling to 3
        ptp_offset = self.get_register(self.__VL6180X_SYSRANGE_PART_TO_PART_RANGE_OFFSET) #scaling3
        self.set_register(self.__VL6180X_SYSRANGE_PART_TO_PART_RANGE_OFFSET, ptp_offset / 3) #scaling3
        self.set_register(self.__VL6180X_SYSRANGE_CROSSTALK_VALID_HEIGHT, 20 / 3) #scaling3
